...
export const FREE_CATEGORIES = ['general', 'pop_culture', 'food_drink']
...
const PROD_API_URL = 'https://aitriviaarena.com/api'
...
export const REVENUECAT_API_KEY =
  (process.env.EXPO_PUBLIC_REVENUECAT_API_KEY as string | undefined) ?? ''

export const ENTITLEMENT_PRO = 'ai.epicai.triviarena Pro'
